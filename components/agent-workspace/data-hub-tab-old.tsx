...
export function DataHubTab({ 
  ...
  const handleDeleteResume = async (resumeId: string) => {
    ...
    try {
      // Download functionality not available in simplified API
      alert('Download feature not available in simplified API')
    } catch (error) {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <FileUploadDialog
        ...
        description="Upload resume files for AI-powered analysis"
